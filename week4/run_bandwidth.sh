#!/bin/bash
# runs pingpong_bandwidth with varying array sizes and outputs CSV

OUTPUT="week4/output/bandwidth_results.csv"
SRC="week4/src/pingpong_bandwidth.c"
BIN="bin/pingpong_bandwidth"
NUM_PINGS=1000
...
for size in 8 36 64 288 512 2304 4096 18432 32768 147456 262144 635760 1048576; do
    ...
    result=$(mpirun -n 2 ./$BIN $NUM_PINGS $size)
